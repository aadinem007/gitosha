  ...
  return (
    <LegalShell title="Privacy Policy" updated="21 July 2026">
      ...
      <ul>
        ...
        <li>
          <strong>Billing:</strong> payment references from Razorpay and/or Stripe (customer,
          session, payment, or subscription IDs). We do not store full card numbers — the payment
          provider processes cards.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>Razorpay — payments (default)</li>
        <li>Stripe — optional alternate payments</li>
