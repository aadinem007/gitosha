...
export const FOUNDRY_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    price: "₹29,999",
    cadence: "one-time",
    description: "Unlimited client builds. White-label. Priority support. Studio Vault for a year.",
    features: [
      "Everything in Solo",
      "Unlimited client projects under one license",
      "White-label rights (remove Shipyard marks)",
      "Client handoff checklist + invoice + proposal templates",
      "White-label delivery guide in the zip",
      "Priority support channel",
      "1 year of Studio Vault included (5 seats)",
    ],
    amountPaise: 2999900,
    mode: "payment",
